...
if ( isset( $_POST[ "submit" ] ) ) {
	...
	if ( $_FILES[ "anh_sp" ][ "name" ] == "" ) {
		$error_anh_sp = "<span class='alert alert-danger'>Vui lòng kiểm tra lại ảnh</span>";
	} else {
	...
	if ( $_POST[ "id_dm" == "unselect" ] ) {
		$error_id_dm = "<span class='alert alert-danger'>Vui lòng chọn nhà cung cấp</span>";
		echo $error_id_dm;
	} else {
		$id_dm = $_POST[ "id_dm" ];
	}
				...
				<form method="post" enctype="multipart/form-data" role="form">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="radio">
								<label>
                    <input type="radio" name="dac_biet" id="optionsRadios1" value=1>
                    Có </label>
							
							</div>
							<div class="radio">
								<label>
                    <input type="radio" name="dac_biet" id="optionsRadios2" value=0 checked>
                    Không </label>
