...
if ( isset( $_SESSION[ 'giohang' ] ) ) {
	...
	while ( $row = mysqli_fetch_array( $query ) ) {
		...
		<td data-th="Product">
		<div class="row">
		<div class="col-sm-2 hidden-xs"><img src="quantri/anh/<?php echo $row['anh_sp']; ?>" alt="..." class="img-responsive"/>
		</div>
		<div class="col-sm-10">
		<h5>
		<?php echo $row['ten_sp']; ?>
	...
	<td class="text-center"><strong>Total <span><?php echo $totalPriceAll; ?></span></strong>
	</td>
	</tr>
	<tr>
	<td>
	...
	<a onClick="return xoaGioHang();" class="btn btn-danger" href="chucnang/giohang/xoahang.php?id_sp=0">Xóa hết sản phẩm</a>
	</td>
	<td class="hidden-xs text-center"><strong>Tổng tiền giỏ hàng: <span><?php echo $totalPriceAll; ?></span></strong>
	</td>
	<td><a href="index.php?page_layout=muahang" class="btn btn-success btn-block">Thanh toán</a>
	</td>
	</tr>
	</tfoot>
	</table>
...
<script>
function xoaGioHang() {
	var conf = confirm( "Bạn có chắc chắn muốn xóa toàn bộ sản phẩm không?" );
	return conf;
}
</script>